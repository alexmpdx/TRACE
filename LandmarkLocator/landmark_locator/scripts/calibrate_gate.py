...
def _collect_metrics(
    ...
    """For each (image, geojson) pair, collect per-landmark metrics where prediction matches GT."""
...
def main() -> None:
    ...
    p.add_argument("--annotation-dir", type=Path, required=True, help="Folder of GeoJSON annotations.")
    p.add_argument("--image-dir", type=Path, required=True, help="Folder of training images.")
